...
This project utilized matplotlib/python in jupyter notebook to analyze ride-sharing data from the company PyBer, a Python-based ride-sharing application. As a new analyst for PyBer, my job was to accurately analyze the data and create compelling visualizations from my analyses to present to the company's CEO.
